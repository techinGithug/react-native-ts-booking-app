        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={{flex: 1, alignItems: "center", justifyContent: "center"}}>
                <View style={{alignItems: "center", marginHorizontal: SIZES.padding}}>
                    ...
                    <Text style={{color: COLORS.gray, marginTop: SIZES.padding, textAlign: "center"}}>Easy solution to buy ticket for your travel, business trip, transportation, lodging and culinary.</Text>
                </View>
                <TouchableOpacity
                ...
                >
                    ...
                    >
                        <Text style={{color: COLORS.white, fontSize: 16}}>Start !</Text>
                    </LinearGradient>
                </TouchableOpacity>
            </View>
        </SafeAreaView>
